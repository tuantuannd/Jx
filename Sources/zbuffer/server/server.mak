...
OBJFILES=KSG_EncodeDecode.o main.o zbuffer.o zport.o zserver.o
ALL_OBJFILES=KSG_EncodeDecode.o main.o zbuffer.o zport.o zserver.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=/root/zbuffer
WUC=
EDITORS=
MAIN_TARGET=server
PROJECT_ITEMS=KSG_EncodeDecode.cpp main.cpp zbuffer.cpp zport.cpp\
	zserver.cpp
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= KSG_EncodeDecode.o main.o zbuffer.o zport.o zserver.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
server:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=KSG_EncodeDecode.cpp /root/zbuffer/zport.h /usr/include/_G_config.h\
...
KSG_EncodeDecode.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=main.cpp /root/zbuffer/zbuffer.h /root/zbuffer/zport.h\
	/root/zbuffer/zserver.h /usr/include/_G_config.h\
...
main.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=zbuffer.cpp /root/zbuffer/zport.h /usr/include/_G_config.h\
	/usr/include/arpa/inet.h /usr/include/asm/sigcontext.h\
	/usr/include/asm/socket.h /usr/include/asm/sockios.h\
	/usr/include/bits/byteswap.h /usr/include/bits/confname.h\
	/usr/include/bits/endian.h /usr/include/bits/environments.h\
...
zbuffer.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=zport.cpp /usr/include/_G_config.h /usr/include/arpa/inet.h\
	/usr/include/asm/sigcontext.h /usr/include/asm/socket.h\
	/usr/include/asm/sockios.h /usr/include/bits/byteswap.h\
	/usr/include/bits/confname.h /usr/include/bits/endian.h\
	/usr/include/bits/environments.h /usr/include/bits/fcntl.h\
...
zport.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=zserver.cpp /root/zbuffer/Cipher.h /root/zbuffer/KSG_EncodeDecode.h\
	/root/zbuffer/zbuffer.h /root/zbuffer/zport.h\
