...
void ZPerf::perfPacket(int size, connection_info *connection) {					//发送或者接收一个数据包
...
bool ZBuffer::receiveData(int index, const char *data, int actsize) {				//接收到一块数据，可能不是正好在边界上，可能有几个数据包
