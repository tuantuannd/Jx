...
OnlineGameLib::Win32::CBuffer::Allocator	CNetwork::m_theGlobalAllocator( 1024 * 64, 50 );
...
bool CNetwork::Create()
{
	...
	sConfigFile = sAppPath + "Intercessor.cfg";
									  ...
									  unsigned short usPortToConnectServer )
{
	...
	{
		pClientFactory->SetEnvironment( 10, 1024 * 1024 );
